 ...
 * @param callback
 */
function extractCharsFromFont(fontSvgText:string, charNameMap:Object, callback:Function, cleanCharacter:?Function) {

    let doc = new DOMParser().parseFromString(fontSvgText, 'text/xml').documentElement,
        ...
        iconSvg = [],
        charMap = charNameMap || {};
    cleanCharacter = cleanCharacter || function (char) {
            return char;
        };
